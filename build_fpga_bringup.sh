...
yosys -p 'read_verilog -sv src/dma_pkg.sv src/spi_master.sv src/spi_psram_ctrl.sv src/ChipInterface_psram_bringup.sv; synth_ecp5 -json build_fpga/synth_out.json -top ChipInterface'
