...
yosys -p 'read_verilog -sv src/dma_pkg.sv src/cfg_reg.sv src/dma_scheduler.sv src/dma_controller.sv src/spi_master.sv src/spi_psram_ctrl.sv fpga/ChipInterface.sv; synth_ecp5 -json build_fpga/synth_out.json -top ChipInterface'
